...
export default function Banner01({ title, description, image, cta, background }: BannerProps) {
    ...
    return (
        <div className='aspect-square bg-cover p-5 relative flex flex-col gap-2 max-w-sm' style={{ backgroundImage: `url(${background})` }}>
